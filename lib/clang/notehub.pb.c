...
/* Generated by nanopb-0.3.5 at Thu May  8 09:02:41 2025. */
...
const pb_field_t notelib_NotehubPB_fields[65] = {
    ...
    PB_FIELD( 56, BOOL    , OPTIONAL, STATIC  , OTHER, notelib_NotehubPB, SuppressResponse, UsageSentBytesSecondary, 0),
    ...
    PB_FIELD( 62, UINT32  , OPTIONAL, STATIC  , OTHER, notelib_NotehubPB, PenaltySecs, PowerMahUsed, 0),
    PB_FIELD( 63, UINT32  , OPTIONAL, STATIC  , OTHER, notelib_NotehubPB, FailedConnects, PenaltySecs, 0),
    PB_FIELD( 64, STRING  , OPTIONAL, STATIC  , OTHER, notelib_NotehubPB, SocketAlias, FailedConnects, 0),
    PB_LAST_FIELD
};
