...
func (x *NotehubPB) GetHubPacketHandler() string {
	if x != nil && x.HubPacketHandler != nil {
		return *x.HubPacketHandler
	}
	return ""
}
...
func (x *NotehubPB) GetPenaltySecs() uint32 {
	if x != nil && x.PenaltySecs != nil {
		return *x.PenaltySecs
	}
	return 0
}

func (x *NotehubPB) GetFailedConnects() uint32 {
	if x != nil && x.FailedConnects != nil {
		return *x.FailedConnects
	}
	return 0
}

func (x *NotehubPB) GetSocketAlias() string {
	if x != nil && x.SocketAlias != nil {
		return *x.SocketAlias
	}
	return ""
}
...
var file_notehub_proto_rawDesc = []byte{
	...
	0x07, 0x6e, 0x6f, 0x74, 0x65, 0x6c, 0x69, 0x62, 0x22, 0xf5, 0x12, 0x0a, 0x09, 0x4e, 0x6f, 0x74,
	...
	0x55, 0x73, 0x65, 0x64, 0x12, 0x20, 0x0a, 0x0b, 0x50, 0x65, 0x6e, 0x61, 0x6c, 0x74, 0x79, 0x53,
	0x65, 0x63, 0x73, 0x18, 0x3e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0b, 0x50, 0x65, 0x6e, 0x61, 0x6c,
	0x74, 0x79, 0x53, 0x65, 0x63, 0x73, 0x12, 0x26, 0x0a, 0x0e, 0x46, 0x61, 0x69, 0x6c, 0x65, 0x64,
	0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x73, 0x18, 0x3f, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e,
	0x46, 0x61, 0x69, 0x6c, 0x65, 0x64, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x73, 0x12, 0x20,
	0x0a, 0x0b, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x40, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0b, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x41, 0x6c, 0x69, 0x61, 0x73,
}
